 ...
 * Use the [BindingAdapterFragment.newInstance] factory method to
...
class BindingAdapterFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment BindingAdapterFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) = BindingAdapterFragment().apply {
